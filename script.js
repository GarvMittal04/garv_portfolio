...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        case "help":
            ...
            break;
        case "skills":
            sendTextMessage("<span class='sk'>I am currently pursuing B.Tech degree in Computer Science Engineering.<br><br>I can comfortably write code in following languages :<br><span class='bold'>Java<br>C++<br>C<br>Python<br>CSS<br>HTML</span><br><br>I've experiance with following frameworks :<span class='bold'><br>ReactJs<br>Figma</span><br><br>I use <span class='bold'>Windows</span> as daily driver on my Asus Tuf A17<br>OS:Windows<br>DE:Gnome(More often) Kde(often)<br>Favourite IDE:VSCode</span>");
            break;
        case "education":
