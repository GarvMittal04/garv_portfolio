...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        case "skills":
            ...
            break;
        case "education":
            sendTextMessage("I am currently pusuing B.Tech degree in Computer Science Engineering from SRM Institute of Science and Technology<br>Passing Year : 2026<br><br>I have completed my secondary school from Vanasthali Public Sr. Sec. School<br>Passing Year:2022<br>Result:70.6%<br>");
            break;
        case "address":
